...
from ethereum2etl_airflow.build_hourly_load_dag_custom import build_hourly_load_dag_custom
...
# airflow DAG
DAG = build_hourly_load_dag_custom(
    dag_id='eth2_mainnet_hourly_load_dag_custom',
    chain='ethereum2',
    **read_load_dag_vars(
